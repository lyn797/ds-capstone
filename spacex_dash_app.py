...
def get_scatter_chart(entered_site, payload_range):
    ...
    # Filter for the selected payload range
    ...
    fig = px.scatter(
        ...
        title='Correlation between Payload Mass and Launch Success - {} for Payloads {} to {}".format(entered_site, payload_range[0], payload_range[1])
    )
    return fig
